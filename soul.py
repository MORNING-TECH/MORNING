...
FORWARD_CHANNEL_ID = -1002186420021
CHANNEL_ID = -1002186420021
error_channel_id = -1002186420021
...
bot = telebot.TeleBot('7408185016:AAFcBlyxP0TbK3XlLD7IwFTLEUJq2_23vTQ')
REQUEST_INTERVAL = 1
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/MORNING_STORE/68*", parse_mode='Markdown')
